...
#include "zugster/cinderpane/MouseListener.h"
#include "zugster/cinderpane/KeyListener.h"
#include "zugster/cinderpane/EventDispatcher.h"
#include "zugster/util/vector.h"
	...
	namespace cinderpane {
		...
		class Interface
		{
		  public:
			...
			ZUGSTER_DELEGATE_VECTOR(PaneVector, m_panes)
